...
<title>아이디 중복검사</title>
    <script>
        ...
        opener.document.join_p.confirm_nickname.value=nicknm;
        self.close();
    }
    </script>
...
<body>
    ...
    <div id="container-checkNm">
        <h3>닉네임 중복검사</h3>
        <form action="checkNm_process.jsp" name="checkNickname_p" method="post">
            ...
            <label>
                <c:choose>
                    <c:when test="${param.result == 1}">
                        <script>
                            opener.document.join_p.nickname.value="";
                        </script>
                    ...
                    <c:when test="${param.result == 0}">
                        <script>
                            opener.document.join_p.nickname.value="${nickname}";
                        </script>
